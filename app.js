...
  // 🔥 FIX 1: Reject notification if we have already clicked/seen it locally!
...
      // 🔥 FIX 2: Mark it as seen locally INSTANTLY so it never duplicates
      if (uniqueId) {
          locallySeenNotifications.add(uniqueId);
      }

      // 🔥 FIX 3: 'Ask' waala barrier hata diya hai. 
      // Ab ek baar click kiya toh notification list se permanently hat jayegi.
